        ...
        <div className="kensington-footer-grid" style={{ 
          ...
          <div style={{ background: 'rgba(255,255,255,0.03)', padding: '24px', border: '1px solid rgba(255,255,255,0.08)' }}>
            ...
            <div style={{ color: '#94A3B8', fontSize: '12px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
              ...
              <div><Mail size={12} style={{ display: 'inline', marginRight: '6px' }} />E-mail: daon3711@naver.com</div>
            </div>
            <a 
              href="tel:1600-0000" 
        ...
        <div className="kensington-footer-legal" style={{ paddingTop: '30px', color: '#64748B', fontSize: '12px', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px', lineHeight: '1.8' }}>
          <div>
            <p style={{ margin: '0 0 4px 0' }}>
              회사명 : (주)다온넷 | 대표 : 변현진 | 사업자 : 217-81-52314 | E-mail : daon3711@naver.com
            </p>
            <p style={{ margin: '0 0 4px 0' }}>
              주소 : 경기도 의정부시 배꽃길 63, 3동 7층 | 개인정보 관리 책임자 : 변현진(daon3711@naver.com)
            </p>
            <p style={{ marginTop: '8px', color: '#475569', margin: '8px 0 0 0' }}>
              © 2026 (주)다온넷. All rights reserved. 본 사이트의 모든 콘텐츠는 저작권법의 보호를 받습니다.
            </p>
          </div>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <span style={{ color: '#94A3B8' }}>여행약관</span>
          </div>
        </div>
      </div>
    </footer>
